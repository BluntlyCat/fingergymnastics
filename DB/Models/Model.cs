namespace HSA.FingerGymnastics.DB.Models
{
    ...
    public abstract class Model : IModel
    {
        ...
        private object ManyToManyQuery(ManyToManyRelation attribute, PropertyInfo column, bool lfc)
        {
        ...
        private object ForeignKeyQuery(ForeignKey attribute, PropertyInfo column, bool lfc)
        {
            object value = null;
        ...
        protected IDictionary<PropertyInfo, object> GetRelations(bool lfc)
        {
            IDictionary<PropertyInfo, object> data = new Dictionary<PropertyInfo, object>();
            ...
            foreach (var foreignKeyRelation in foreignKeyRelations)
            {
                ...
                var value = ForeignKeyQuery(attribute, foreignKeyRelation, lfc);
            ...
            foreach (var manyToManyRelation in manyToManyRelations)
            {
                ...
                var value = ManyToManyQuery(attribute, manyToManyRelation, lfc);
        ...
        public virtual void SetRelations(bool lfc)
        {
        ...
        public static T GetModel<T>(object primaryKey, bool lfc = true) where T : Model
        {
